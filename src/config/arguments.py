...
class BAITArguments:
    ...
    disable_uncertainty_inspection: bool = field(default=False, metadata={"help": "Disable uncertainty inspection and use argmax at ambiguous steps"})
    log_token_probs: bool = field(default=False, metadata={"help": "Write per-step token probability traces to result.json"})
...
class ScanArguments:
    ...
    uncertainty_inspection_topk: int = field(default=5, metadata={"help": "Override BAIT uncertainty inspection top-k"})
    disable_uncertainty_inspection: bool = field(default=False, metadata={"help": "Disable uncertainty inspection and use argmax"})
    log_token_probs: bool = field(default=False, metadata={"help": "Include token_prob_trace in result.json"})
